...
namespace LingGame
{
    ...
    internal class Gizmo_LingMoon_ShieldStatus : Gizmo
    {
        ...
        public override GizmoResult GizmoOnGUI(Vector2 topLeft, float maxWidth, GizmoRenderParms parms)
        {
            ...
            Find.WindowStack.ImmediateWindow(shield.def.defName.GetHashCode(), overRect, WindowLayer.GameUI, delegate
            {
                ...
                var fillPercent = shield.Power / Mathf.Max(1f, shield.MaxPower);
                Widgets.FillableBar(rect3, fillPercent, FullShieldBarTex, EmptyShieldBarTex, false);
                Text.Font = GameFont.Small;
                Text.Anchor = TextAnchor.MiddleCenter;
                Widgets.Label(rect3, shield.Power.ToString("F0") + " / " + shield.MaxPower.ToString("F0"));
